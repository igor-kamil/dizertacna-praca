...
\usepackage{url}
\def\UrlBreaks{\do\/\do-} % Better line breaks in URLs
\widowpenalty=10000
\clubpenalty=10000
\raggedbottom % Better than forcing vertical stretch between paragraphs
...
% --- Font Configuration ---
\usepackage{fontspec}
\setmainfont{Async Sans}[StylisticSet=1]
\setsansfont{Async Sans}[StylisticSet=1]
\setmonofont{Menlo}
