...
Digitalizácia zbierok bola dlhé roky sprevádzaná eufóriou z otvorenosti.
Verejne financované inštitúcie mohli zrazu napĺňať svoju misiu „sprístupňovať“ v mierke, ktorú fyzická galéria nedokáže: bez geografickej bariéry, bez otváracích hodín, bez limitu výstavných priestorov.
...
Online zbierky rozširujú rozsah, ale pozornosť sa nekopíruje spolu s rozsahom. Kolekcia môže rásť do desaťtisícov či stotisícov položiek, no používateľská skúsenosť sa často ustáli na úzkom výbere diel, ktoré sa opakovane objavujú vo výsledkoch vyhľadávania, v externých odkazoch, v zdieľaniach a v interných prehľadoch. Vzniká napätie medzi šírkou prístupu a skutočnou viditeľnosťou.

Tento paradox sa v internetovej kultúre často opisuje pojmom *long tail*. Chris Anderson ho spopularizoval ako sľub digitálnej distribúcie: keď odpadnú priestorové a logistické obmedzenia, hodnota sa môže presúvať od niekoľkých hitov k množstvu okrajových položiek, ktoré spolu vytvoria významný celok [@anderson2004]. V takejto optike by online zbierky mali prirodzene oslabovať kanonické hierarchie, pretože aj menej známe diela sú konečne dostupné.

V prostredí zbierok sa však rýchlo ukáže, že dostupnosť je len jedna premenná. Brynjolfsson, Hu a Smith upozorňujú, že podstatnou vlastnosťou internetu nie je iba väčšia ponuka, ale schopnosť online systémov pomáhať ľuďom položky vyhľadávať, hodnotiť a objavovať [@brynjolfsson2006longtail]. *Long tail* sa tu mení z prirodzeného efektu digitalizácie na otázku sprostredkovania: ako sa k chvostu vôbec dá dostať, čo z neho robí skúsenosť a čo ho necháva len ako zásobu dát.
...
## 5.5 Filterworld: odporúčanie bez prekvapenia
...
Pre používateľa je to lákavé. V prebytku sa hodí, keď systém vyberá za nás. Problém je, že odporúčanie si často mýli „zaujímavé“ s „podobné“. Personalizácia potom nevedie k napätiu a objavu, ale k tomu, že sa človek pohybuje v kruhu známych tvarov. Aj v oblasti filmu je to intuitívne: odporúčanie postavené na tom, čo sa páčilo veľa ľuďom, prirodzene tlačí k univerzálnym titulom. No mnohé silné zážitky vznikajú práve vtedy, keď sa človek stretne s niečím, čo nie je všeobecne kompatibilné, čo je generačne, formálne alebo tematicky špecifické. Takéto odbočky sa do metriky „páčilo sa podobným ľuďom“ zmestia len ťažko.

V odbornej literatúre o odporúčacích systémoch sa tento jav pomenúva ako *popularity bias*: algoritmy majú tendenciu odporúčať populárne položky neúmerne často, zatiaľ čo menej populárne položky sú podreprezentované. Abdollahpouri a kolektív to formulujú priamo a viažu to aj na problém *long tail*: odporúčanie zvyšuje expozíciu toho, čo je už aj tak často hodnotené a videné, a tým sťažuje objavovanie položiek v chvoste [@abdollahpouri_unfairness_popularity_bias_2019]. Z pohľadu používateľa to znamená menej rozmanitosti; z pohľadu katalógu to znamená, že sa neviditeľnosť stáva systémovou vlastnosťou.

Pre online zbierky umenia má *filterworld* špecifickú podobu. Zbierka je databáza položiek a rozhranie musí vyriešiť otázku: čo ukázať ďalej. Keď chýbajú explicitné historické, autorské a kurátorské väzby, systém siahne po náhradných mechanizmoch. Najčastejšie sú to odporúčania založené na podobnosti, kategóriách a na signáloch pozornosti. Výsledkom je plynulý režim prechádzania: pozerám dielo, kliknem na podobné, prekliknem ďalšie, a tak ďalej. Je to hladký pohyb, ktorý však nevytvára napätie a nepomáha pochopiť, prečo sú veci vedľa seba.
