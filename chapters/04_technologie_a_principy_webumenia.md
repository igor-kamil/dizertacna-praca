...
Tento typ náhleho porozumenia je blízky tomu, čo Arthur Koestler opisuje ako mechanizmus tvorivého „aha“ momentu. Koestler ho chápe ako stret dvoch dovtedy oddelených myšlienkových rámcov, ktoré sa v jednom okamihu prepoja do nového významu – jav, ktorý nachádza nielen vo vtipe, ale aj v matematickom dôkaze, vedeckom objave či porozumení zložitého príbehu [@koestler_humor_1964]. V kontexte digitálnej zbierky nejde o nový objav v dejinách umenia, ale o situáciu, v ktorej rozhranie umožní používateľovi pochopiť vzťahy medzi dielami bez potreby dodatočného vysvetľujúceho textu. Práve v takýchto momentoch sa rozhranie správa ako kurátor – nie tým, že rozpráva príbeh priamo, ale tým, že vytvára podmienky pre jeho samostatné rozpoznanie.
