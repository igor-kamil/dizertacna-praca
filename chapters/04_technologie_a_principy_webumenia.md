...
Deleuze a Guattari používajú pojem rhizómu ako kritiku stromových, hierarchických modelov myslenia, ktoré predpokladajú jasný pôvod, poradie a nadradenosť jednotlivých častí. Rhizóm naopak opisuje štruktúru bez centra, bez jedného začiatku a bez pevne určeného smeru čítania, v ktorej môžu významy vznikať prostredníctvom neustále sa meniacej siete vzťahov. Tento koncept vznikol ako filozofická metafora, no v priebehu nasledujúcich desaťročí sa ukázal ako prekvapivo presný opis fungovania digitálnych sietí a webových prostredí.

Pri návrhu Webu umenia som si čoraz viac uvedomoval, že tradičné modely uvažovania o zbierkach – lineárne, hierarchické a kanonické – len ťažko zodpovedajú tomu, ako sa dá v digitálnom prostredí s umením reálne pracovať. Databáza síce vyžaduje štruktúru, no samotná používateľská skúsenosť sa neodohráva v pevnom poradí, ale v sieti asociácií, návratov a preskokov. Práve v tomto napätí medzi databázovou organizáciou a sieťovým čítaním sa metafora rhizómu ukazuje ako mimoriadne užitočný rámec.

Tento spôsob uvažovania sa objavuje aj v diskusiách o digitálnej histórii umenia. Ako píše Merete Sanderhoff v kapitole *Art History on the Internet’s Terms* v publikácii *Sharing Is Caring*, internet zásadne narúša predstavu jedného autoritatívneho výkladu a umožňuje chápať dejiny umenia ako sieť prepojených príbehov, ku ktorým je možné vstupovať z rôznych miest a sledovať rôzne trajektórie [@sanderhoff_art_history_internet_terms_2014, pp. 44–48]. Rhizóm tu nefunguje len ako metafora štruktúry webu, ale aj ako kritický nástroj, ktorý spochybňuje stabilitu kánonu a otvára priestor pre pluralitu čítaní.
...
Táto kapitola sa preto nepozerá na technológie ako na neutrálnu infraštruktúru, ale ako na formu myslenia. Architektúra systému, dátové modely, API či vyhľadávanie tu vystupujú ako nástroje, ktoré umožňujú – alebo naopak obmedzujú – vznik takéhoto rhizomatického čítania zbierky. Text vychádza z konkrétnej skúsenosti s vývojom Webu umenia v Slovenskej národnej galérii a vedome sa posúva od všeobecných „state of the art“ modelov k remeselnému opisu rozhodnutí, kompromisov a slepých uličiek.
...
Najjasnejšie sa prepojenie architektúry a interpretácie ukázalo pri prototype výstavy *Dve krajiny* [@dvekrajiny_sng_2014]. Práve tam sa začali objavovať drobné rozhodnutia, ktoré na prvý pohľad pôsobia ako čisto dizajnérske, no v skutočnosti zásadne ovplyvňujú „tempo“ čítania zbierky. Veľkosť náhľadov v katalógu v porovnaní s kolekciami nie je len otázkou estetiky, ale rozhodnutím o tom, či sa používateľ pohybuje rýchlo naprieč veľkým množstvom diel, alebo zostáva dlhšie pri detailoch. Podobne funguje aj poradie a členenie sekcií: zatiaľ čo vo fyzickej výstave sú sekcie často oddelené miestnosti, ktoré prirodzene vytvárajú trasu pohybu, v digitálnom prostredí je preskok medzi „miestnosťami“ okamžitý. Aj tu však poradie a štruktúra rozhrania nenápadne navrhujú spôsob prechádzania obsahom.

Osobitnú rolu zohrávajú momenty, keď sa dáta v rozhraní začnú správať inak, než sa očakávalo. Pri mapových zobrazeniach sa ukázalo, že niektoré tematické okruhy sa priestorovo usporiadajú s prekvapivou presvedčivosťou: hrady, zámky a ruiny začali vytvárať zreteľnú geografickú líniu, zatiaľ čo procesy modernizácie sa prirodzene viazali na rieky a dopravné trasy. Takéto vizuálne usporiadanie spätne pomáhalo „čítať“ jednotlivé diela a ich súvislosti.

Tento typ náhleho porozumenia je blízky tomu, čo Arthur Koestler opisuje ako mechanizmus tvorivého „aha“ momentu. Koestler ho chápe ako stret dvoch dovtedy oddelených myšlienkových rámcov, ktoré sa v jednom okamihu prepoja do nového významu – jav, ktorý nachádza nielen vo vtipe, ale aj v matematickom dôkaze, vedeckom objave či porozumení zložitého príbehu [@koestler_humor_1964]. V kontexte digitálnej zbierky nejde o nový objav v dejinách umenia, ale o situáciu, v ktorej rozhranie umožní používateľovi pochopiť vzťahy medzi dielami bez potreby vysvetľujúceho textu. Práve v takýchto momentoch sa rozhranie správa ako kurátor – nie tým, že rozpráva príbeh priamo, ale tým, že vytvára podmienky pre samostatné rozpoznanie.
...
Z perspektívy starostlivosti je open source možné čítať aj ako súčasť širších sietí zodpovednosti. Annet Dekker v koncepte *networks of care* opisuje digitálne infraštruktúry ako vzťahové zostavy ľudí, technológií a inštitúcií, v ktorých sa starostlivosť neviaže na jeden centrálny subjekt, ale je rozptýlená v čase a medzi aktérmi. Ako píše, starostlivosť v digitálnom prostredí „*is not taken on by isolated individuals, but spread out over a wide range of people, tools and infrastructures*“ [@dekker_networks_of_care_2022, p. 192].

Otvorený kód v tomto zmysle nepredstavuje garanciu kvality, ale skôr pozvanie k spoluzodpovednosti: vytvára podmienky, v ktorých sa systém môže udržiavať, opravovať a rozvíjať prostredníctvom siete vzťahov, nie jednorazového autorského zásahu.
...
Rozhodnutia o sprístupňovaní digitálnych zbierok sa neodohrávajú len na úrovni technológie. Sú to rozhodnutia právne, etické a v konečnom dôsledku aj kultúrne. Otázka *čo* zverejniť, *v akej kvalite* a *za akých podmienok* priamo súvisí s tým, ako inštitúcia rozumie svojej verejnej úlohe.

Už pri spustení Webu umenia v roku 2015 sa Slovenská národná galéria — s jednoznačnou podporou vedenia — rozhodla sprístupniť autorskoprávne voľné diela na stiahnutie v plnom rozlíšení. Nebolo to samozrejmé rozhodnutie. V odbornej komunite prevládala skôr opatrnosť: obavy zo zneužitia reprodukcií, z komerčného využitia bez kontroly, ale aj z možných zásahov do integrity diela. Objavovali sa aj argumenty o riziku falšovania, najmä pri dostupnosti vysokokvalitných detailov.
