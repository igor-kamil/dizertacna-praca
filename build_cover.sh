...
# Build standalone outer cover PDF for dissertation.
# Usage: ./build_cover.sh

root_dir="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
build_dir="${root_dir}/_build"
input_md="${build_dir}/cover_outer.md"
output_pdf="${root_dir}/cover_outer.pdf"
output_pdf_uncompressed="${build_dir}/cover_outer.uncompressed.pdf"
defaults_file="${root_dir}/pandoc/cover_outer.defaults.yaml"
